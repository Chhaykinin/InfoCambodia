                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive text-center" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            <?php
                                                $sql_select ="SELECT * FROM tbl_contact";
                                                    ...
                                                    echo '
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="./tbl_contact_update.php?id='.$row['id'].' " class="btn_delete btn btn-success waves-effect waves-linght" >Update</a>
                                                            </td>
                                                        </tr>
                                                    ';
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-footer">
                                                <form action="" method="post">
                                                    <input type="hidden" name="delete_contact" id="delete_logo">
                                                    <button class="btn btn-danger" name="btn_delete_contact">Yes</button>
