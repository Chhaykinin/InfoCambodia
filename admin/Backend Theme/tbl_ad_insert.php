                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" id="" name="link">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <button name="btn_insert_ad" type="submit" class="btn btn-info waves-effect waves-linght">Insert Advertiesment</button>
