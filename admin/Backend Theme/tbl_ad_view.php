                                                ...
                                                while($row=mysqli_fetch_assoc($result)){
                                                    echo '
                                                        <tr>
                                                            <td>'.$row['id'].'</td>
                                                            <td>
                                                                <img width="100px" src="./Image/'.$row['ad_img'].'" alt="">
                                                            </td>
                                                            <td>
                                                                '.$row['link'].'
                                                            </td>
                                                            <td>
                                                                <a href="./tbl_ad_update.php?id='.$row['id'].'" class="btn_delete btn btn-primary waves-effect waves-linght"  >Update</a>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-footer">
                                                <form action="" method="post">
                                                    <input type="hidden" name="delete_ad" id="delete_logo">
                                                    <button class="btn btn-danger" name="btn_delete_ad">Yes</button>
